                    ...
                    <div className={styles.filter_box_2}>
                      <form>
                        ...
                        >
                          ...
                          <option value="OrderByMoreExpensive">
                            More expensive
                          </option>
                          <option value="OrderByLessExpensive">
                            Less expensive
                          </option>
                        </select>
                      </form>
                      <form>
                        ...
                        <select
                          ...
                          id=""
                          onChange={(event) =>
                            artistSelector(event.target.value)
                          }
                          defaultValue="base"
                        >
                          <option disabled={true} value="base">
                      ...
                      <form>
                        ...
                        <select
                          ...
                          id=""
                          onChange={(event) =>
                            mediumSelector(event.target.value)
                          }
                          defaultValue="base"
                        >
                          <option disabled={true} value="base">
              ...
              <footer className={styles}>
                ...
                <div className={styles.footer_info}>
                  <p>
                    ...
                    debitis suscipit corporis ratione blanditiis, quae
                    perferendis sapiente, exercitationem hic rerum unde! Quasi
                    dolorem velit officiis corrupti aut in provident obcaecati!
                  </p>
                </div>
              </footer>
            </div>
