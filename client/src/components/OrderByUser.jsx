...
import { getOrderByUser, getOrderUserDetail, filterOrderRejectedrUser, filterOrderAprovedUser } from "../actions";
       ...
       <div className={styles.body}>
        ...
        <div className={styles.panelRight} >
          <div className={styles.filter_container}>
            <button className={styles.filter_button} onClick={()=>dispatch(filterOrderRejectedrUser())}>Filter by rejected</button>
            <button className={styles.filter_button} onClick={()=>dispatch(filterOrderAprovedUser())}>Filter by aproved</button>
          
          </div>
        {
            ordersUser[0]?ordersUser.map(e => {
                return (
