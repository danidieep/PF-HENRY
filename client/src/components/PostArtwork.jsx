      ...
      <div className={styles.containerRegister}>
        ...
        <div className={styles.formContainer}>
          ...
          <form onSubmit={e => handleSubmit(e)} >
            ...
            {/* -------------------------   date       */}
            <div className={styles.optForm}>
              <input type="number" name="date" value={input.date} autoComplete="off" placeholder="Year" onChange={e => { handleChange(e) }} />
            ...
            <div className={styles.optForm}>
              <input type="input" name="collecting_institution" value={input.collecting_institution} autoComplete="off" placeholder="Institution" onChange={e => { handleChange(e) }} />
            ...
            {/* -------------------------   creator       */}
            <div className={styles.optForm}>
              <select onChange={(e) => { handleSelect(e) }} defaultValue="base">
                <option disabled={true} value="base">Artist</option>
                {
                  artists?.map((a) => {
                    return (

                      <option key={a.id} name={a.name} value={a.name}>{a.name}</option>
                    )
                  })
                }
              </select>
            ...
            <div className={styles.optForm}>
              ...
              <input type="input" name="dimensions" value={input.dimensions} autoComplete="off" placeholder="Dimensions" onChange={e => { handleChange(e) }} />
            ...
            {/* -------------------------   medio       */}
            <div className={styles.optForm}>
              <input type="input" name="medio" value={input.medio} autoComplete="off" placeholder="Medium" onChange={e => { handleChange(e) }} />
            ...
            {/* -------------------------   price       */}
            <div className={styles.optForm}>
              <input type="input" name="price" value={input.price} autoComplete="off" placeholder="Price" onChange={e => { handleChange(e) }} />
